...
> I've included the short snippets to install most of these using [Homebrew](http://brew.sh/). The installation instructions for [Homebrew](#homebrew) and [Homebrew Cask](#homebrew-cask) are also included. If you would prefer not to use either, you can click on the titles for their project pages.
